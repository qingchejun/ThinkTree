...
1.  **全面性第一 (Comprehensiveness First):** 相比于简洁，**信息的完整性**拥有绝对优先权。
2.  **绝对忠于原文 (Absolute Fidelity to the Source):** 严禁添加、推断或演绎任何原文未明确提及的信息。所有输出都必须能在原文中找到直接或间接的依据。不要进行任何形式的个人总结或观点升华。
3.  **逻辑清晰，层层递进 (Clear Logic, Progressive Layers):** 保持文档的原始结构和层级关系
...
1. 不要添加任何解释性文字，只输出思维导图结构。
2. 思维导图中屏蔽所有作者、来源、时间等无关信息。
3. 思维导图中屏蔽“例如”、“比如”等解释性词汇。
---
**原始材料如下：**
