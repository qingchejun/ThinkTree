...
**当前版本**: v3.2.3-stable 🚀 Google 一键登录 + 完整积分系统 + 商业化就绪
...
- 🚀 **Google 一键登录**: OAuth 2.0 集成/账户关联/便捷登录体验 (v3.2.3 ✅)
- 💰 **完整积分系统**: AI 调用计费/每日奖励/兑换码/明细追踪 (v3.2.3 ✅)
- 🎯 **成本控制**: 操作前预估/积分不足提示/透明消费机制 (v3.2.3 ✅)
...
## 🚀 v3.2.3 重大更新 (2025-08-02)

### 🎯 Google 一键登录
- **无缝体验**: Google OAuth 2.0 集成，告别复杂注册流程
- **账户关联**: 现有用户可直接关联 Google 账户，新用户自动创建
- **多重保障**: 传统登录 + Google OAuth 双重选择，确保访问便利性
- **智能回调**: 流畅的 OAuth 处理，登录状态实时同步

### 💰 完整积分系统
- **透明计费**: AI 调用按积分消耗，用户清楚每次操作成本
- **每日奖励**: 登录获得积分奖励，提升用户活跃度和留存
- **兑换机制**: 积分兑换码生成、校验和兑换，灵活的积分获取方式
- **详细明细**: 完整的消费记录和积分流水，用户随时掌握使用情况
- **成本预估**: 操作前实时预估积分消耗，避免意外超支
- **友好提示**: 积分不足时智能引导，提供充值和获取积分的途径

### 🔧 技术升级
- **OAuth 安全**: 基于 authlib 的标准 OAuth 2.0 实现
- **数据完整**: 积分系统事务安全，确保数据一致性
- **向后兼容**: 新功能不影响现有用户和功能
- **商业就绪**: 为即将到来的 Stripe 支付集成做好准备
