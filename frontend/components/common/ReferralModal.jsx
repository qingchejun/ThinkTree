          ...
          <div>
            ...
            <div className="mt-3 p-3 border rounded-lg bg-gray-50">
              ...
              <div className="flex items-center gap-2">
                <input readOnly value={linkInfo.referral_link || ''} className="flex-1 px-3 py-2 border rounded" />
                <button onClick={copy} className="px-3 py-2 text-sm bg-black text-white rounded">{copied ? '已复制' : '复制'}</button>
              </div>
